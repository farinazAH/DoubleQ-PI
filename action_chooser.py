# Alamiyan: THis file has been modified. Add e_greed_base variable
...
# ______________________________________________________________________________________________________________________
    def __init__ (self, e_greed, e_greed_base, total_time ):

        self.e_greed_base = e_greed_base
...
# ______________________________________________________________________________________________________________________
    def get(self, Q_object, state):
        ...
        self.e_greed = self.e_greed_base + 0.3*np.exp(-self.e_greed_counter/60.*(1./1.))
